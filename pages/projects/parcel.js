    ...
    <div id='projects' className={styles.container}>
      ...
      >
        <div className={styles.proCotents}>
          ...
          <p className={styles.intro}>this brief is for group nine media’s video intelligence system. parcel’s intended use is to highlight video trends and track user engagement metrics.</p>
