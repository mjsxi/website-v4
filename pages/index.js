    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.heading}>
          <span>matt sullivan</span> is a product designer in NYC focusing on building out design systems and building up teams to achieve success with empathy, understanding, and support.</div>
