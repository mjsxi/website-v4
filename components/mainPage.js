  ...
  <>
    ...
    <div className={styles.subhead}>
      ...
      >
        ...
        <p>You can find me on <a target="_blank" href="//twitter.com/mjsxi">Twitter</a> (I'm currently tweeting about Animal Crossing), <a target="_blank" href="//instagram.com/mjsxi/">Instagram</a>, and if you’re here for it <a target="_blank" href="//linkedin.com/in/matt-sullivan-5455656a/">Linkedin</a>. Feel free to reach out by <a href="mailto:msullivanxi@gmail.com">email</a> if you're looking to connect!</p>
      </motion.div>
    </div>
  </>
);
