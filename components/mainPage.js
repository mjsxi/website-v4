...
const MainPage = () => (
  <div>
    <div className={styles.heading}>
      <h1><span>hi im matt sullivan</span>, a product designer in nyc, my main focus is around empowering teams and building out design systems. I enjoy helping others, and designing products through listening and empathy.</h1>
    </div>
    <div className={styles.subhead}>
      ...
      <div className={styles.about}>
        ...
        <p>You can find me on <a target="_blank" href="//twitter.com/mjsxi">Twitter</a> (where I'm currently tweeting about Animal Crossing), <a target="_blank" href="//instagram.com/mjsxi/">Insta</a> (where I gram occationally), and if you’re here for it <a target="_blank" href="//linkedin.com/in/matt-sullivan-5455656a/">Linkedin</a>.</p>
      </div>
    </div>
  </div>
);
